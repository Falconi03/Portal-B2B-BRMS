...
const Norisk = () => {
    ...
    const submit = (props: { nome: string, email: string, telefone: string, token: string }) => {
        ...
        if (termo === true && nome.length > 2 && telefone.replace(/[^0-9]/g, '').length > 9 && /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}$/i.test(email) && token !== '') {
            const bodyParameters = { nome: nome, email: email, telefone: telefone.replace(/[^0-9]/g, ''), marca: 'norisk', token: token }
    ...
    return (
        <div className="black-page">
            {cadastro ?
                ...
                :
                <div className="black">
                    <img src='https://black.norisk.com.br/images/blackfriday_norisk.png' alt="" />
                    ...
                    <div className="formulario">
                        ...
                        <div className="form-check">
                            ...
                            <label className="form-check-label" htmlFor="checkbox1">{"Sim, eu autorizo o recebimento de comunicações (WhatsApp, SMS, e-mail e ligação). "} <a href="https://www.noriskbr.com.br/institucional/politica-de-privacidade">Saiba mais</a> </label>
